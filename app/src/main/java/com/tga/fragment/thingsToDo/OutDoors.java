 ...
 */
public class OutDoors extends Fragment implements ThingsToDoLoad.ItemClickListener, ThingsToDoLoad.RetryLoadMoreListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loadJSON(request,request.getOutDoors());
