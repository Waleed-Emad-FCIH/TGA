...
import com.tga.R;
import com.tga.adapter.NeedToKnowAdapter;
...
public class NeedToKnow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("HEALTH & EMERGENCIES"));
        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);

        final ViewPager viewPager = (ViewPager) findViewById(R.id.pager);
        final NeedToKnowAdapter adapter = new NeedToKnowAdapter
